...
![image-20240726140311794](../../../../repo/assets/MSSQL/image-20240726140311794.png)
...
![image-20240726114741500](../../../../repo/assets/MSSQL/image-20240726114741500.png)

###### 创建数据库

![image-20240726114603007](../../../../repo/assets/MSSQL/image-20240726114603007.png)
...
![image-20240726150945234](../../../../repo/assets/MSSQL/image-20240726150945234.png)
...
![image-20240726151055245](../../../../repo/assets/MSSQL/image-20240726151055245.png)
...
![image-20240726145355390](../../../../repo/assets/MSSQL/image-20240726145355390.png)
...
![image-20240726151911178](../../../../repo/assets/MSSQL/image-20240726151911178.png)
...
![image-20240726152423531](../../../../repo/assets/MSSQL/image-20240726152423531.png)
...
![image-20240726154041832](../../../../repo/assets/MSSQL/image-20240726154041832.png)
...
![image-20240726155025413](../../../../repo/assets/MSSQL/image-20240726155025413.png)
...
![image-20240726155223134](../../../../repo/assets/MSSQL/image-20240726155223134.png)

```mssql
select name from master..sysdatabases order by name; --获取所有数据库名称
```

![image-20240726155319980](../../../../repo/assets/MSSQL/image-20240726155319980.png)

```mssql
select * from syscolumns where id=object_id('student'); --获取所有字段名称
```

![image-20240726155423143](../../../../repo/assets/MSSQL/image-20240726155423143.png)

```mssql
Select @@VERSION; --查询数据库版本
```

![image-20240726155612657](../../../../repo/assets/MSSQL/image-20240726155612657.png)
...
![image-20240726194811851](../../../../repo/assets/MSSQL/image-20240726194811851.png)
...
![image-20240726200326848](../../../../repo/assets/MSSQL/image-20240726200326848.png)

删除依赖

![image-20240726200648121](../../../../repo/assets/MSSQL/image-20240726200648121.png)
...
![image-20240726202410490](../../../../repo/assets/MSSQL/image-20240726202410490.png)
...
![image-20240726203716091](../../../../repo/assets/MSSQL/image-20240726203716091.png)
...
![image-20240726214407393](../../../../repo/assets/MSSQL/image-20240726214407393.png)

```mssql
select * from student;
```

![image-20240726214520787](../../../../repo/assets/MSSQL/image-20240726214520787.png)
...
![image-20240726214619021](../../../../repo/assets/MSSQL/image-20240726214619021.png)
...
![image-20240726214746668](../../../../repo/assets/MSSQL/image-20240726214746668.png)
...
![image-20240726214822932](../../../../repo/assets/MSSQL/image-20240726214822932.png)
...
![image-20240726214856858](../../../../repo/assets/MSSQL/image-20240726214856858.png)
...
![image-20240727100310064](../../../../repo/assets/MSSQL/image-20240727100310064.png)
...
![image-20240727100346165](../../../../repo/assets/MSSQL/image-20240727100346165.png)

![image-20240727102306519](../../../../repo/assets/MSSQL/image-20240727102306519.png)
...
![image-20240727102332222](../../../../repo/assets/MSSQL/image-20240727102332222.png)
...
![image-20240727102355261](../../../../repo/assets/MSSQL/image-20240727102355261.png)
...
![image-20240727102414051](../../../../repo/assets/MSSQL/image-20240727102414051.png)
...
![image-20240727102444606](../../../../repo/assets/MSSQL/image-20240727102444606.png)

![image-20240727102648192](../../../../repo/assets/MSSQL/image-20240727102648192.png)
...
![image-20240727110719361](../../../../repo/assets/MSSQL/image-20240727110719361.png)
...
![image-20240727144632162](../../../../repo/assets/MSSQL/image-20240727144632162.png)
...
![image-20240727145103690](../../../../repo/assets/MSSQL/image-20240727145103690.png)
...
![image-20240727145737229](../../../../repo/assets/MSSQL/image-20240727145737229.png)
...
![image-20240727153433249](../../../../repo/assets/MSSQL/image-20240727153433249.png)

![image-20240727153503345](../../../../repo/assets/MSSQL/image-20240727153503345.png)

![image-20240727153541697](../../../../repo/assets/MSSQL/image-20240727153541697.png)

![image-20240727153634469](../../../../repo/assets/MSSQL/image-20240727153634469.png)

![image-20240727153734257](../../../../repo/assets/MSSQL/image-20240727153734257.png)

![image-20240727153931985](../../../../repo/assets/MSSQL/image-20240727153931985.png)

![image-20240727154002150](../../../../repo/assets/MSSQL/image-20240727154002150.png)

![image-20240727154137654](../../../../repo/assets/MSSQL/image-20240727154137654.png)
...
![image-20240727155911560](../../../../repo/assets/MSSQL/image-20240727155911560.png)
...
![image-20240727162411244](../../../../repo/assets/MSSQL/image-20240727162411244.png)
...
![image-20240727162946891](../../../../repo/assets/MSSQL/image-20240727162946891.png)
...
![aae4a1f9e64114ca3f7a579c8bd02a7](../../../../repo/assets/MSSQL/aae4a1f9e64114ca3f7a579c8bd02a7.png)
...
![image-20240727193231141](../../../../repo/assets/MSSQL/image-20240727193231141.png)
...
![image-20240727170248034](../../../../repo/assets/MSSQL/image-20240727170248034.png)

![image-20240727170351248](../../../../repo/assets/MSSQL/image-20240727170351248.png)

![image-20240727170635273](../../../../repo/assets/MSSQL/image-20240727170635273.png)

![image-20240727170727700](../../../../repo/assets/MSSQL/image-20240727170727700.png)
...
![image-20240727173600399](../../../../repo/assets/MSSQL/image-20240727173600399.png)
...
![image-20240727141159906](../../../../repo/assets/MSSQL/image-20240727141159906.png)

## 六、数据备份

### 6.1 图形化操作流程

![image-20240729092859102](../../../../repo/assets/MSSQL/image-20240729092859102.png)

![image-20240729093138600](../../../../repo/assets/MSSQL/image-20240729093138600.png)

![image-20240729093326080](../../../../repo/assets/MSSQL/image-20240729093326080.png)

![image-20240729093401294](../../../../repo/assets/MSSQL/image-20240729093401294.png)

![image-20240729093450775](../../../../repo/assets/MSSQL/image-20240729093450775.png)
...
![image-20240729094343802](../../../../repo/assets/MSSQL/image-20240729094343802.png)

![image-20240729095422737](../../../../repo/assets/MSSQL/image-20240729095422737.png)
...
![image-20240729094735386](../../../../repo/assets/MSSQL/image-20240729094735386.png)
...
![image-20240729100953503](../../../../repo/assets/MSSQL/image-20240729100953503.png)
...
![image-20240729101300419](../../../../repo/assets/MSSQL/image-20240729101300419.png)
...
![image-20240729101405173](../../../../repo/assets/MSSQL/image-20240729101405173.png)
...
![image-20240729101719658](../../../../repo/assets/MSSQL/image-20240729101719658.png)
...
![image-20240729105826482](../../../../repo/assets/MSSQL/image-20240729105826482.png)

#### 访问

http://192.168.70.21:81/st.php

![image-20240729111257404](../../../../repo/assets/MSSQL/image-20240729111257404.png)
...
![image-20240729110125791](../../../../repo/assets/MSSQL/image-20240729110125791.png)

![image-20240729110215744](../../../../repo/assets/MSSQL/image-20240729110215744.png)

![image-20240729110244423](../../../../repo/assets/MSSQL/image-20240729110244423.png)
...
![image-20240729143840230](../../../../repo/assets/MSSQL/image-20240729143840230.png)
...
![image-20240729151138910](../../../../repo/assets/MSSQL/image-20240729151138910.png)

http://192.168.70.21:81/st1.php

![image-20240729151054487](../../../../repo/assets/MSSQL/image-20240729151054487.png)
...
![image-20240729143755492](../../../../repo/assets/MSSQL/image-20240729143755492.png)
...
![image-20240729151759061](../../../../repo/assets/MSSQL/image-20240729151759061.png)
...
![img](../../../../repo/assets/MSSQL/wps1.jpg)

2、SQL SERVER企业管理器->数据库->对应数据库->用户中删除无关帐号;

![img](../../../../repo/assets/MSSQL/wps2.jpg) 
...
![image-20240729153553843](../../../../repo/assets/MSSQL/image-20240729153553843.png)
...
![img](../../../../repo/assets/MSSQL/wps3.jpg) 
...
![img](../../../../repo/assets/MSSQL/wps4.jpg) 

![img](../../../../repo/assets/MSSQL/wps5.jpg) 

2.更改数据库属性，取消业务数据库帐号不需要的"数据库访问许可"和"数据库角色中允许”中不需要的角色。

![img](../../../../repo/assets/MSSQL/wps6.jpg) 

![img](../../../../repo/assets/MSSQL/wps7.jpg) 
...
![img](../../../../repo/assets/MSSQL/wps8.jpg)

![img](../../../../repo/assets/MSSQL/wps9.jpg) 
...
![img](../../../../repo/assets/MSSQL/wps10.jpg) 
...
![img](../../../../repo/assets/MSSQL/wps11.jpg)
