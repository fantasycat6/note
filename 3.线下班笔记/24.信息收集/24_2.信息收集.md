...
google_api_id = 'a7bd3e319eba1490b'  # Google API自定义搜索引擎id
# https://developers.google.com/custom-search/v1/overview#api_key
google_api_key = 'AIzaSyBhcmFoNDnu1OIC401JGSBSt6VLnDLoO-M'  # Google API自定义搜索key
...
```
apt install apktool
./apk-getLink.sh tc /root/gongju/LinkFinder
```
...
在获取这些信息后，可以在Github/Linkedin等社交、招聘网站中进一步查找这些人在互联网上发布

的与目标站点有关的一切信息，分析并发现有用的信息。此外，可以对获取到的邮箱进行密码爆破
...
1. 1、国家企业信用信息公示系统: http://www.gsxt.gov.cn/index.html
2. 2、信用中国-个人信用查询搜索-企业信息查询搜索-统一社会信用代码查询: https://www.creditchina.gov.cn/
3. 3、公司的公众号、企业号、网站，员工的网盘、百度文库等可能会存在一些敏感信息，如VPN/堡垒机账号、TeamViewer账号、网络设备默认口令、服务器默认口令等。例如：深信服VPN 有一些默认的账号密码
...
1. 1、https://www.reg007.com/
2. 2、https://namechk.com/
3. 3、https://www.blackbookonline.info/
4. 4、https://aleph.occrp.org/
5. 5、https://monitor.firefox.com/ 
6. 6、https://ghostproject.fr/
