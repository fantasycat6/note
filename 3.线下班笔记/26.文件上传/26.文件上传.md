...
> ###### 属性值
>
> ![image-20240830103401594](../../../../repo/assets/26.文件上传/image-20240830103401594.png)
>
> ##### method属性
>
...
> ###### 属性值
>
> ![image-20240830103422505](../../../../repo/assets/26.文件上传/image-20240830103422505.png)
...
> 服务器请求状态码：
>
> ![image-20240830110816295](../../../../repo/assets/26.文件上传/image-20240830110816295.png)
>
...
![image-20240831102649880](../../../../repo/assets/26.文件上传/image-20240831102649880.png)
...
![image-20240831102540282](../../../../repo/assets/26.文件上传/image-20240831102540282.png)
...
> 3.参数：
>
> ![image-20240831112636542](../../../../repo/assets/26.文件上传/image-20240831112636542.png)
>
> 4.示例：
>
> //移除字符串两侧的字符（"Hello" 中的 "He" 以及 "World" 中的 "d!"）
>
> ![image-20240831112657265](../../../../repo/assets/26.文件上传/image-20240831112657265.png)
>
> 输出： 
>
> Hello World!
...
> 3.参数：
>
> ![image-20240831113345783](../../../../repo/assets/26.文件上传/image-20240831113345783.png)
>
> 4.示例：
>
> ```bash
...
> 3.参数：
>
> ![image-20240831113402003](../../../../repo/assets/26.文件上传/image-20240831113402003.png)
>
> 4.示例
>
> ![image-20240831113415642](../../../../repo/assets/26.文件上传/image-20240831113415642.png)
>
> #### （3）strrpos()
>
> 1.功能：
...
> 3.参数：
>
> ![image-20240831113429140](../../../../repo/assets/26.文件上传/image-20240831113429140.png)
>
> 4.示例
>
> ![image-20240831113436468](../../../../repo/assets/26.文件上传/image-20240831113436468.png)
...
![image-20240902111201197](../../../../repo/assets/26.文件上传/image-20240902111201197.png)

![image-20240902111229143](../../../../repo/assets/26.文件上传/image-20240902111229143.png)

![image-20240902111658173](../../../../repo/assets/26.文件上传/image-20240902111658173.png)

![image-20240902112808707](../../../../repo/assets/26.文件上传/image-20240902112808707.png)

![image-20240902111011354](../../../../repo/assets/26.文件上传/image-20240902111011354.png)

![image-20240902111800387](../../../../repo/assets/26.文件上传/image-20240902111800387.png)
...
> 3.参数：
>
> ![image-20240831160943874](../../../../repo/assets/26.文件上传/image-20240831160943874.png)
>
> 4.示例： 搜索 "What" 在字符串中最后出现的位置，并返回从该位置到字符串结尾的所有字符： 
>
> ![image-20240831160957780](../../../../repo/assets/26.文件上传/image-20240831160957780.png)
>
...
> 3.参数：
>
> ![image-20240831161010741](../../../../repo/assets/26.文件上传/image-20240831161010741.png)
>
> 4.返回值：替换后的字符
>
> 5.示例：把字符串 "Hello world!" 中的字符 "WORLD"（不区分⼤⼩写）替换成"Shanghai"： 
>
> ![image-20240831161023990](../../../../repo/assets/26.文件上传/image-20240831161023990.png)
>
> 输出： Hello Shanghai! 
>
> ```
...
> ##### burp抓包
>
> ![image-20240831211623632](../../../../repo/assets/26.文件上传/image-20240831211623632-1725240264248-49.png)
>
> ![image-20240831211807362](../../../../repo/assets/26.文件上传/image-20240831211807362-1725240264248-50.png)
>
> ![image-20240831211835157](../../../../repo/assets/26.文件上传/image-20240831211835157-1725240264248-51.png)
>
> ##### 设置无payload,重复请求
>
> ![image-20240831211706545](../../../../repo/assets/26.文件上传/image-20240831211706545-1725240264248-52.png)
>
> ##### 线程30
>
> ![image-20240831211729541](../../../../repo/assets/26.文件上传/image-20240831211729541-1725240264248-53.png)
>
> #### burp运行
>
> ![image-20240831214520912](../../../../repo/assets/26.文件上传/image-20240831214520912-1725240264248-54.png)
>
> #### 不断访问create.php
>
> ##### create.php内容
...
> #### python脚本运行
>
> ![image-20240831214237854](../../../../repo/assets/26.文件上传/image-20240831214237854-1725240264248-55.png)
>
> ![image-20240831214258914](../../../../repo/assets/26.文件上传/image-20240831214258914-1725240264248-56.png)
>
> #### 蚁剑连接
>
> ```
...
> ```
>
> ![image-20240831214420396](../../../../repo/assets/26.文件上传/image-20240831214420396-1725240264248-58.png)
>
> ![image-20240831214435686](../../../../repo/assets/26.文件上传/image-20240831214435686-1725240264248-57.png)
>
> ![image-20240831214814062](../../../../repo/assets/26.文件上传/image-20240831214814062-1725240264248-59.png)
...
![image-20240831193052897](../../../../repo/assets/26.文件上传/image-20240831193052897.png)
...
![上传漏洞分类](../../../../repo/assets/26.文件上传/mind-map.png)

![判断上传漏洞类型](../../../../repo/assets/26.文件上传/sum_up.png)
...
![image-20240901082503047](../../../../repo/assets/26.文件上传/image-20240901082503047.png)

### 蚁剑设置burp代理

![image-20240901082554651](../../../../repo/assets/26.文件上传/image-20240901082554651.png)

#### burp抓包

![image-20240901082734968](../../../../repo/assets/26.文件上传/image-20240901082734968.png)
...
![image-20240901083147331](../../../../repo/assets/26.文件上传/image-20240901083147331.png)
...
![image-20240901085847474](../../../../repo/assets/26.文件上传/image-20240901085847474.png)

![image-20240901085915307](../../../../repo/assets/26.文件上传/image-20240901085915307.png)
...
![image-20240901090002470](../../../../repo/assets/26.文件上传/image-20240901090002470.png)
...
![image-20240901090232241](../../../../repo/assets/26.文件上传/image-20240901090232241.png)

### 冰蝎设置burp代理

![image-20240901090302137](../../../../repo/assets/26.文件上传/image-20240901090302137.png)

##### burp抓包

![image-20240901090418041](../../../../repo/assets/26.文件上传/image-20240901090418041.png)

![image-20240901090529314](../../../../repo/assets/26.文件上传/image-20240901090529314.png)
...
![image-20240901090952339](../../../../repo/assets/26.文件上传/image-20240901090952339.png)

![image-20240901091029930](../../../../repo/assets/26.文件上传/image-20240901091029930.png)
...
![image-20240901091651104](../../../../repo/assets/26.文件上传/image-20240901091651104.png)
...
![image-20240901095501346](../../../../repo/assets/26.文件上传/image-20240901095501346.png)

#### 抓包流量，查看情况

![image-20240901094640771](../../../../repo/assets/26.文件上传/image-20240901094640771.png)

**因为phpStudy安装在C盘，没有默认安装在D盘，导致哥斯拉连接不上。**

![image-20240901095827123](../../../../repo/assets/26.文件上传/image-20240901095827123.png)

#### 测试：创建`D:\phpStudy\tmp`

![image-20240901095220082](../../../../repo/assets/26.文件上传/image-20240901095220082.png)

![image-20240901095341044](../../../../repo/assets/26.文件上传/image-20240901095341044.png)

#### 测试：创建`D:\phpStudy\tmp\tmp`

![image-20240901095056312](../../../../repo/assets/26.文件上传/image-20240901095056312.png)

![image-20240901095151979](../../../../repo/assets/26.文件上传/image-20240901095151979.png)
...
![image-20240901100018998](../../../../repo/assets/26.文件上传/image-20240901100018998.png)

![image-20240901100115576](../../../../repo/assets/26.文件上传/image-20240901100115576.png)

![image-20240901100404272](../../../../repo/assets/26.文件上传/image-20240901100404272.png)
...
![image-20240901100727455](../../../../repo/assets/26.文件上传/image-20240901100727455.png)

![image-20240901100909259](../../../../repo/assets/26.文件上传/image-20240901100909259.png)

#### 2.数据包⻓度

数据包**⻓度达万个**

![image-20240901100941395](../../../../repo/assets/26.文件上传/image-20240901100941395.png)

![image-20240901101013952](../../../../repo/assets/26.文件上传/image-20240901101013952.png)
...
![image-20240901101225097](../../../../repo/assets/26.文件上传/image-20240901101225097.png)
...
```
 ...
 ![image-20240901101251507](../../../../repo/assets/26.文件上传/image-20240901101251507.png)
...
![image-20240901101400136](../../../../repo/assets/26.文件上传/image-20240901101400136.png)

![image-20240901101422099](../../../../repo/assets/26.文件上传/image-20240901101422099.png)

## 菜刀

### 菜刀连接

![image-20240901083816705](../../../../repo/assets/26.文件上传/image-20240901083816705.png)

### 使用Wireshark抓包

抓取VMWare的`VMnet 8`网卡

![image-20240901083947469](../../../../repo/assets/26.文件上传/image-20240901083947469.png)

![image-20240901084113196](../../../../repo/assets/26.文件上传/image-20240901084113196.png)

### 右击追踪流

![image-20240901084200041](../../../../repo/assets/26.文件上传/image-20240901084200041.png)

![image-20240901084216611](../../../../repo/assets/26.文件上传/image-20240901084216611.png)

### base64解码

![image-20240901084700115](../../../../repo/assets/26.文件上传/image-20240901084700115.png)

### 总结

#### 1.菜⼑伪造User-Agent为爬⾍⽂件

![image-20240901085127323](../../../../repo/assets/26.文件上传/image-20240901085127323.png)
...
![image-20240901085051744](../../../../repo/assets/26.文件上传/image-20240901085051744.png)
